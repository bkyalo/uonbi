...
class icon_system extends icon_system_fontawesome {
    ...
    public function get_core_icon_map() {
        ...
        return [
            ...
            'core:i/contentbank' => 'fa-cube',
            'core:i/course' => theme_uonbi_get_setting('courseicon'),
            ...
            'core:i/files' => 'icon-docs',
            'core:i/filter' => 'fa-filter',
            'core:i/flagged' => 'fa-flag',
            'core:i/folder' => 'icon-folder',
            ...
            'core:i/navigationitem' => 'icon-settings',
            ...
            'core:i/permissionlock' => 'icon-lock',
            'core:i/permissions' => 'icon-lock-open',
            'core:i/persona_sign_in_black' => 'fa-male',
            'core:i/portfolio' => 'fa-id-badge',
            'core:i/preview' => 'fa-search-plus',
            'core:i/privatefiles' => 'icon-docs',
            ...
            'core:t/preferences' => 'icon-settings',
            ...
            'core:t/unblock' => 'fa-commenting-o',
            'core:t/unlocked' => 'icon-lock-open',
            'core:t/unlock' => 'icon-lock',
            'core:t/up' => 'fa-arrow-up',
            'core:t/user' => 'icon-user',
            'core:t/viewdetails' => 'icon-list',
    ...
    /**
     * Clear cache and reload the map.
     */
    public function reset_map() {
        $this->map = [];
        $cache = \cache::make('core', 'fontawesomeiconmapping');
        $cache->delete('mapping');
        $this->get_icon_name_map();
    }
}

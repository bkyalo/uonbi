...
/**
 * Privacy Subsystem implementation for theme_uonbi.
 *
 * @package    theme_uonbi
...
/**
 * The uonbi theme stores a user preference data.
 *
 * @package    theme_uonbi
 * @copyright  2020 Matt Porritt <mattp@catalyst-au.net>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_uonbi');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_uonbi');
            }

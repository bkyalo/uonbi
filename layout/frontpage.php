...
$nav->initialise();
theme_uonbi_extend_flat_navigation($nav);
$templatecontext['flatnavigation'] = $nav;
$templatecontext['firstcollectionlabel'] = $nav->get_collectionlabel();

echo $OUTPUT->render_from_template('theme_uonbi/frontpage', $templatecontext);
